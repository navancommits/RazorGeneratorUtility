...
namespace RazorGeneratorUtility
{
    class Program
    {
        ...
        {
            var SlnPath = @"";//C:\Projects\xyz\xyz-main-site-9.2\xyz.MainSite\xyz.Mainsite.sln
       ...
       {
            string[] files = Directory.GetFiles(@"C:\Projects\xyz\xyz-main-site-9.2\xyz.MainSite\", "*.generated.cs", SearchOption.AllDirectories);
        ...
        {
            string[] files = Directory.GetFiles(@"C:\Projects\xyz\xyz-main-site-9.2\xyz.MainSite\", "RazorGeneratorMvcStart.cs", SearchOption.AllDirectories);
